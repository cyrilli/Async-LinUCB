...
from lib.UGapE_sync import UGapE_mult
from lib.UGapE_full import UGapE_full
...
if __name__ == '__main__':
	...
	if dataset == 2:
		...
		algorithms['gap=.1_data2_Hom_L'] = UGapE_full(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=1)
		algorithms['gap=.2_data2_Hom_L'] = UGapE_full(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=2)
		algorithms['gap=.3_data2_Hom_L'] = UGapE_full(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=3)
		algorithms['gap=.4_data2_Hom_L'] = UGapE_full(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=4)
		algorithms['gap=.5_data2_Hom_L'] = UGapE_full(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=5)
		...
		algorithms['gap=.1_data2_Hom_D'] = DisTarPE(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=1, n_clients=n_users, gamma=gamma)
		algorithms['gap=.2_data2_Hom_D'] = DisTarPE(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=2, n_clients=n_users, gamma=gamma)
		algorithms['gap=.3_data2_Hom_D'] = DisTarPE(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=3, n_clients=n_users, gamma=gamma)
		algorithms['gap=.4_data2_Hom_D'] = DisTarPE(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=4, n_clients=n_users, gamma=gamma)
		algorithms['gap=.5_data2_Hom_D'] = DisTarPE(dimension=5, epsilon=epsilon, 
								delta= delta, NoiseScale=NoiseScale, 
								dataset=dataset, case=case, gap=5, n_clients=n_users, gamma=gamma)
